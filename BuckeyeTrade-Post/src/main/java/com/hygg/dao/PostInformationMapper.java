...
public interface PostInformationMapper {
     ...
     * @mbggenerated
     */
    List<PostInformation> selectByExampleWithBLOBs(PostInformationExample example);
     ...
     * @mbggenerated
     */
    int updateByExampleWithBLOBs(@Param("record") PostInformation record, @Param("example") PostInformationExample example);
     ...
     * @mbggenerated
     */
    int updateByPrimaryKeyWithBLOBs(PostInformation record);
